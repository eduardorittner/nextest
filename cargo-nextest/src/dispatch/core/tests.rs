...
fn test_argument_parsing() {
    ...
    let valid: &[&'static str] = &[
        ...
        "cargo nextest store export-junit abc123",
        "cargo nextest store export-junit -R latest",
        "cargo nextest store export-junit --run-id abc123",
        "cargo nextest store export-junit latest -o junit.xml",
        "cargo nextest store export-junit latest --output junit.xml",
        "cargo nextest store export-junit archive.zip",
        "cargo nextest store export-junit /path/to/run.zip",
        "cargo nextest store export-junit -R ./relative/path.zip",
        "cargo nextest store export-junit /proc/self/fd/11",
        "cargo nextest store export-junit /dev/fd/5",
        "cargo nextest store export-junit latest --report-name my-report",
